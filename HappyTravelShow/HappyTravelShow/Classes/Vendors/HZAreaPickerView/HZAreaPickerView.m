...
- (void)showInView:(UIView *) view
{
    ...
    self.frame = CGRectMake(0, view.frame.size.height, self.frame.size.width - 20, self.frame.size.height + 10);
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.frame = CGRectMake(0, view.frame.size.height - self.frame.size.height, self.frame.size.width - 20, self.frame.size.height + 10);
    }];
}
