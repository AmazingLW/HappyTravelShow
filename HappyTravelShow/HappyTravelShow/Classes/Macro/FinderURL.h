...
//发现各种景点页面数据接口拼接
#define mURL(id,cityCode,pageIndex)[NSString stringWithFormat:@"http://apiphp.yaochufa.com/portal/theme/themeinfo?system=ios&pageSize=10&channel=AppStore&id=%ld&cityCode=%@&version=4.3.0&pageIndex=%ld",id,cityCode,pageIndex]
#endif
